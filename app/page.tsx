...
export default function Home() {
  return (
    <main className="relative min-h-[calc(100vh-80px)] bg-[#0d0914] text-off-white overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-6 z-30 relative w-full flex items-center h-full">
      ...
      {/* Massive Absolute Isometric Graphic */}
      <section className="absolute top-1/2 left-[20%] sm:left-[35%] lg:left-[40%] xl:left-[45%] -translate-y-1/2 w-[900px] lg:w-[1300px] xl:w-[1500px] aspect-[1468/845] flex items-center justify-center z-10 pointer-events-none">
        
        {/* Strong Center Glow BEHIND Grid so grid lines stay crisp */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40%] h-[60%] bg-[#a855f7] rounded-full blur-[100px] opacity-40 z-0" />
