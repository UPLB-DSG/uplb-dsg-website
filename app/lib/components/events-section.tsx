          ...
          <div className="w-full md:w-1/3 h-full overflow-y-auto border-r border-white/10 bg-black/20 flex flex-col">
            {PAST_EVENTS.map((event, idx) => (
              ...
              >
                ...
                <h4
                  className={`text-lg md:text-xl font-bold ${activeEventIndex === idx ? "text-white" : "text-white/50"}`}
                >
                  {event.title}
                </h4>
              </button>
            ...
            <div
              className={`absolute inset-0 transition-colors duration-1000 ${
                activeEventIndex % 3 === 0
                  ? "bg-gradient-to-br from-accent-main/20 via-[#111] to-black"
                  : activeEventIndex % 3 === 1
                    ? "bg-gradient-to-bl from-accent-secondary/20 via-[#111] to-black"
